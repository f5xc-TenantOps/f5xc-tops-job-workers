...
@patch("origin_pool_create.function._get_parameters")
@patch("origin_pool_create.function._get_xc_client")
def test_create_origin_pool_already_exists_patterns(mock_get_xc_client, mock_get_params, error_message):
...
@patch("origin_pool_create.function._get_parameters")
@patch("origin_pool_create.function._get_xc_client")
def test_create_origin_pool_http_409_conflict(mock_get_xc_client, mock_get_params):
...
@patch("origin_pool_create.function._get_parameters")
@patch("origin_pool_create.function._get_xc_client")
def test_create_origin_pool_http_409_via_response(mock_get_xc_client, mock_get_params):
